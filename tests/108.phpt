--TEST--
Satellite compatibility: Passing an object
--SKIPIF--
...
$object = new OrbitObject(new InputParameters(), "IDL:InputParameters:1.0");
$demo = new OrbitObject(new ObjectParameter(), "IDL:ObjectParameter:1.0");
